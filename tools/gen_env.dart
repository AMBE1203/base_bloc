...
void main() {
  ...
  for (var x in flavorsList) {
    allDartDefinesByEnv[x.flavorEnum] =
        readDartDefineFromEnv(x.envPath, x);
  }
...
class SettingsJsonWriter extends LaunchJsonWriter {
  SettingsJsonWriter(
      {required Map<FlavorsEnum, Map<String, String>> dartDefinesByEnv})
      : super(filePath: settingsJsonPath, dartDefinesByEnv: dartDefinesByEnv);
...
class LaunchJsonWriter {
  ...
  String writeConfig(String fileContent) {
    ...
    print('configJson: ${configJson.toString()}');
